...
class TFT18(framebuf.FrameBuffer):
    ...
    def TFT_init(self):
        ...
        self.send((ST7735_MADCTL_MX | ST7735_MADCTL_MY | ST7735_MADCTL_ML), DAT)   
    ...
    def set_RAM_address(self):
        self.set_windows(1, 1,  self.width,  (self.height)) 
