...
class BME280_I2C():
    def __init__(self, _i2c, _i2c_address = BME280_I2C_address):
        self.i2c = _i2c
    ...
    def read_word(self, address):
        retval = 0
        value = self.i2c.readfrom_mem(self.i2c_address, address, 2)
    ...
    def read_long(self, address):
        retval = 0
        value = self.i2c.readfrom_mem(self.i2c_address, address, 3)
